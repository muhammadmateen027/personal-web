        ...
        <div className="parallax">
            ...
            <div className="git-cont row">
                <div className="col-12 col-sm-6 half">
                    <form action={contact.contactUrl ? contact.contactUrl : "https://formspree.io/f/mgebkypr"} method={contact.contactUrl ? "POST" : "POST"}>
                        <input type="text" id="fname" name="firstname" placeholder="Your name" required></input>
                        <input type="email" id="mailid" name="email" placeholder="Email Address" required></input>
